/*
 * @(#) stdif/configurable/set_uint8.c
 *
 * Configurable Interface - set_uint8@1.0 wrapper.
 *
...
/**
 * Set a property value as an unsigned 8-bit integer.
 *
 * This is a convenience function that calls
 * @{param configurable}@{code ->ops->v0.op_set_uint8( ... )}
 *
 ...
 * @since	1.0
 *
 * @see		@{func stdif_configurable_get_uint8__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, uint8_t *)}
 */
extit_status_t
EXTIT_DECL
...
#define	IMPL(x)		((stdif_configurable_1_0_t *) (x))
	...
	return IMPL(configurable)->ops->v0.op_set_uint8(
