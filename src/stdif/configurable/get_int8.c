/*
 * @(#) stdif/configurable/get_int8.c
 *
 * Configurable Interface - get_int8@1.0 wrapper.
 *
...
/**
 * Get a property value as a signed 8-bit integer.
 *
 * This is a convenience function that calls
 * @{param configurable}@{code ->ops->v0.op_get_int8( ... )}
 *
 ...
 * @since	1.0
 *
 * @see         @{func stdif_configurable_set_int8__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, int8_t)}
 */
extit_status_t
EXTIT_DECL
...
#define	IMPL(x)		((stdif_configurable_1_0_t *) (x))
	...
	return IMPL(configurable)->ops->v0.op_get_int8(
