...
main(int argc, char **argv)
{
	 ...
	 */
	if(iv_repository_set(ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,1),
	...
	if(iv_repository_set(ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,2),
	...
	if(iv_repository_set(ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,4),
	...
	if(iv_repository_set(ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,5),
	 &foo_prototype_0_5, NULL) != IV_REPOSITORY_STATUS_OK)
	{
		fprintf(stderr,
	...
	if(iv_repository_set(ir, NULL, FOO_INTERFACE_ID, IV_VERSION(1,4),
	...
	if(iv_repository_set(ir, NULL, FOO_INTERFACE_ID, IV_VERSION(2,1),
	...
	if(iv_repository_set(ir, NULL, FOO_INTERFACE_ID, IV_VERSION(2,2),
	...
	if(iv_repository_set(ir, NULL, BAR_INTERFACE_ID, IV_VERSION(1,3),
	...
	if(iv_repository_set(ir, NULL, BAR_INTERFACE_ID, IV_VERSION(2,2),
	...
	if(iv_repository_set(ir, NULL, BAR_INTERFACE_ID, IV_VERSION(3,0),
	...
	if((version = iv_repository_query(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,1))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,4))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(1,0))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(1,4))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(1,5))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(2,0))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(2,2))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(3,0))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(1,0))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
			"Found interface %s@%u.%u (from v1.0)\n",
			BAR_INTERFACE_ID,
	...
	if((version = iv_repository_query(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(2,0))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
			"Found interface %s@%u.%u (from v2.0)\n",
			BAR_INTERFACE_ID,
	...
	if((version = iv_repository_query(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(3,0))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	...
	if((version = iv_repository_query(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(4,0))) != IV_VERSION_NONE)
	{
		fprintf(stderr,
	 ...
	 * foo@0.x
	 */
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,1))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,2))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,3))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,4))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,5))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(0,8))) != NULL)
	{
		fprintf(stderr,
	 ...
	 */
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(1,0))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(1,1))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(1,4))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(1,5))) != NULL)
	{
		fprintf(stderr,
	 ...
	 */
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(2,0))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(2,1))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(2,2))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(2,3))) != NULL)
	{
		fprintf(stderr,
	 ...
	 */
	if((gi = iv_repository_get(
	 ir, NULL, FOO_INTERFACE_ID, IV_VERSION(3,0))) != NULL)
	{
		fprintf(stderr,
	 ...
	 */
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(1,0))) != NULL)
	{
		fprintf(stderr,
			"Found interface %s@1.0  [%s]\n",
			BAR_INTERFACE_ID,
	...
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(1,1))) != NULL)
	{
		fprintf(stderr,
			"Found interface %s@1.1  [%s]\n",
			BAR_INTERFACE_ID,
	...
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(1,2))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(1,3))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(1,4))) != NULL)
	{
		fprintf(stderr,
	 ...
	 */
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(2,0))) != NULL)
	{
		fprintf(stderr,
			"Found interface %s@2.0  [%s]\n",
			BAR_INTERFACE_ID,
	...
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(2,1))) != NULL)
	{
		fprintf(stderr,
			"Found interface %s@2.1  [%s]\n",
			BAR_INTERFACE_ID,
	...
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(2,2))) != NULL)
	{
		fprintf(stderr,
			"Found interface %s@2.2  [%s]\n",
			BAR_INTERFACE_ID,
	...
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(2,3))) != NULL)
	{
		fprintf(stderr,
			"Found unexpected interface %s@2.3  [%s]\n",
			BAR_INTERFACE_ID,
	 ...
	 */
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(3,0))) != NULL)
	{
		fprintf(stderr,
	...
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(3,1))) != NULL)
	{
		fprintf(stderr,
	 ...
	 */
	if((gi = iv_repository_get(
	 ir, NULL, BAR_INTERFACE_ID, IV_VERSION(4,0))) != NULL)
	{
		fprintf(stderr,
