/*
 * @(#) stdif/configurable/get_int64.c
 *
 * Configurable Interface - get_int64@1.0 wrapper.
 *
...
/**
 * Get a property value as a signed 64-bit integer.
 *
 * This is a convenience function that calls
 * @{param configurable}@{code ->ops->v0.op_get_int64( ... )}
 *
 ...
 * @since	1.0
 *
 * @see		@{func stdif_configurable_set_int64__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, int64_t)}
 */
extit_status_t
EXTIT_DECL
...
#define	IMPL(x)		((stdif_configurable_1_0_t *) (x))
	...
	return IMPL(configurable)->ops->v0.op_get_int64(
