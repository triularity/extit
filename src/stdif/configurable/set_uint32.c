/*
 * @(#) stdif/configurable/set_uint32.c
 *
 * Configurable Interface - set_uint32@1.0 wrapper.
 *
...
/**
 * Set a property value as an unsigned 32-bit integer.
 *
 * This is a convenience function that calls
 * @{param configurable}@{code ->ops->v0.op_set_uint32( ... )}
 *
 ...
 * @since	1.0
 *
 * @see		@{func stdif_configurable_get_uint32__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, uint32_t *)}
 */
extit_status_t
EXTIT_DECL
...
#define	IMPL(x)		((stdif_configurable_1_0_t *) (x))
	...
	return IMPL(configurable)->ops->v0.op_set_uint32(
