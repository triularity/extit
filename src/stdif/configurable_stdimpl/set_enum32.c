 ...
 * @since	1.0
 *
 * @see         @{func stdif_configurable_stdimpl_get_enum32__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, uint32_t *)}
 * @see         @{func stdif_configurable_stdimpl_set_enum32__1_0_base(stdif_configurable_t *, void *, stdif_configurable_propref_t *, uint32_t)}
 */
extit_status_t
EXTIT_DECL
 ...
 * @since	1.0
 *
 * @see         @{func stdif_configurable_stdimpl_get_enum32__1_0_base(stdif_configurable_t *, void *, stdif_configurable_propref_t *, uint32_t *)}
 * @see         @{func stdif_configurable_stdimpl_set_enum32__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, uint32_t)}
 */
extit_status_t
EXTIT_DECL
