 ...
 *
 * Configurable Interface - set_int8@1.0 standard implementation.
 *
...
/**
 * Standard implementation to set a property value as a signed 8-bit integer.
 *
 ...
 * @since	1.0
 *
 * @see         @{func stdif_configurable_stdimpl_get_int8__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, int8_t *)}
 * @see         @{func stdif_configurable_stdimpl_set_int8__1_0_base(stdif_configurable_t *, void *, stdif_configurable_propref_t *, int8_t)}
 */
extit_status_t
EXTIT_DECL
 ...
 * @since	1.0
 *
 * @see         @{func stdif_configurable_stdimpl_get_int8__1_0_base(stdif_configurable_t *, void *, stdif_configurable_propref_t *, int8_t *)}
 * @see         @{func stdif_configurable_stdimpl_set_int8__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, int8_t)}
 */
extit_status_t
EXTIT_DECL
