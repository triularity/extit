 ...
 * @since	1.0
 *
 * @see         @{func stdif_configurable_stdimpl_set_bool__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, bool)}
 * @see         @{func stdif_configurable_stdimpl_get_bool__1_0_base(stdif_configurable_t *, void *, stdif_configurable_propref_t *, bool *)}
 */
extit_status_t
EXTIT_DECL
 ...
 * @since	1.0
 *
 * @see         @{func stdif_configurable_stdimpl_set_bool__1_0_base(stdif_configurable_t *, void *, stdif_configurable_propref_t *, bool)}
 * @see         @{func stdif_configurable_stdimpl_get_bool__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, bool *)}
 */
extit_status_t
EXTIT_DECL
