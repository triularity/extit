/*
 * @(#) stdif/configurable/set_int16.c
 *
 * Configurable Interface - set_int16@1.0 wrapper.
 *
...
/**
 * Set a property value as a signed 16-bit integer.
 *
 * This is a convenience function that calls
 * @{param configurable}@{code ->ops->v0.op_set_int16( ... )}
 *
 ...
 * @since	1.0
 *
 * @see		@{func stdif_configurable_get_int16__1_0(stdif_configurable_t *, stdif_configurable_propref_t *, int16_t *)}
 */
extit_status_t
EXTIT_DECL
...
#define	IMPL(x)		((stdif_configurable_1_0_t *) (x))
	...
	return IMPL(configurable)->ops->v0.op_set_int16(
