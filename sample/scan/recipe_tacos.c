...
)
{
	...
	impl->recipe.name = "Tacos";
	impl->recipe.prep_time = 10;
	impl->recipe.total_time = 13;
	impl->recipe.prepare = prepare_tacos;
...
EXTIT_DECLARE_PMODULE("{eaeb9b4b-234e-11e4-a457-406186e454c1}", IV_VERSION(1,0), "Tacos Recipe", "1.0", &plugin_ops)
