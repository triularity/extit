 ...
 *
 * Configurable Interface - set_double@1.0 standard implementation.
 *
...
/**
 * Standard implementation to set a property value as a 64-bit floating point.
 *
...
/**
 * Standard implementation helper to set a property value as a 64-bit
 * floating point.
 *
 * @note	The property will be left unchanged if anything except
 *		@{constant EXTIT_STATUS_OK} is returned.
