 ...
 * @since	1.0
 *
 * @see		@{func stdif_configurable_stdimpl_get_int64__1_0_base(stdif_configurable_1_0_t *, void *, stdif_configurable_propref_t *, int64_t *)}
 * @see		@{func stdif_configurable_stdimpl_set_int64__1_0(stdif_configurable_1_0_t *, stdif_configurable_propref_t *, int64_t)}
 */
extit_status_t
EXTIT_DECL
