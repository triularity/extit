...
)
{
	...
	impl->recipe.name = "Pie";
	impl->recipe.prep_time = 20;
	impl->recipe.total_time = 65;
	impl->recipe.prepare = prepare_pie;
...
EXTIT_DECLARE_PMODULE("{3e29e568-234d-11e4-a457-406186e454c1}", IV_VERSION(1,0), "Pecan Pie Recipe", "1.0", &plugin_ops)
